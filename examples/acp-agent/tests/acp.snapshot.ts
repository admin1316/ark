...
it('pins native DeepSeek Files offload and inline fallback in assembled requests', async () => {
  ...
  try {
    ...
    expect(offloaded?.content).toEqual([
      { type: 'text', text: 'Compare the older image ' },
      {
        ...
        text: expect.stringContaining(
          '[image omitted to fit request image limits; sha256:b1ff9c8ea3a780bad09b346c423d2d0e46815926879b18e841d928376a946640.',
        ) as string,
      },
      { type: 'text', text: ' with the newer image ' },
      {
        type: 'text',
        text: expect.stringContaining(
          'Image sha256:b1ff9c8ea3a780bad09b346c423d2d0e46815926879b18e841d928376a946640; request preview 1x1px.',
        ) as string,
      },
    ...
    expect(followup).toEqual([
      {
        role: 'user',
        content: expect.stringContaining('Compare the older image [image omitted to fit request image limits;') as string,
      },
      {
        role: 'user',
      ...
      },
      {
        ...
        content: expect.stringContaining(
          'Image "red.png" (sha256:b1ff9c8ea3a780bad09b346c423d2d0e46815926879b18e841d928376a946640); request preview 1x1px.',
        ) as string,
      },
      {
        role: 'user',

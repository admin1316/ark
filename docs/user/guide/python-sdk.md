...
This tutorial installs the published Python SDK, runs a checked-in agent composition, and shows how to call the harness from your own program without a user-interface process.

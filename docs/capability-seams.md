...
| `ctx.agentTeams` | `core` | [`agent-team`](../packages/subagent/agent-team) | - | [`tool-agent-team`](../packages/subagent/tool-agent-team), [`experimental-agent-team`](../packages/experimental/agent-team) | - | Owns the implicit-root roster, durable peer mailbox, shared task DAG, and continuable-child lifecycle. tool-agent-team contributes model controls; experimental-agent-team adapts this domain to the agentTeams Remote namespace without owning a second team runtime. |
| `ctx.agentTeamRemote` | `core` | [`experimental-agent-team`](../packages/experimental/agent-team) | - | - | - | Projects the agentTeams coordination domain through the agentTeams Remote namespace; task mutations and team state remain owned by agent-team. |
...
| `ctx.directoryPicker` | `seam` | [`host-directory-picker`](../packages/host/directory-picker) | [`host-directory-picker-native`](../packages/host/directory-picker-native) | [`api-workspace-controller`](../packages/api/workspace-controller) | - | The native backend opens an OS directory chooser on the host display. |
| `ctx.webServer` | `core` | [`host-webserver`](../packages/host/webserver) | - | [`host-connection`](../packages/host/connection) | - | HTTP carrier and named-route registry for the authenticated Native API transport. |
| `ctx.connection` | `core` | [`host-connection`](../packages/host/connection) | - | [`api-gateway`](../packages/api/gateway), [`host-native-events`](../packages/host/native-events) | - | Owns authenticated RPC transport, response routing, downloads, and event socket lifecycle. |
| `ctx.nativeEvents` | `core` | [`host-native-events`](../packages/host/native-events) | - | [`host-connection`](../packages/host/connection) | - | Projects existing session and interaction owners onto Native event streams and response routes. |
...
| `ctx.dynamicCordisRunner` | `core` | [`cordis-host-runner`](../packages/extensions/cordis-host-runner) | - | [`tool-cordis`](../packages/extensions/tool-cordis) | - | Owns the in-memory definition registry, Host plugin vm sandbox, and session-owned activation and fiber lifecycle. |
| `ctx.cordisInspect` | `core` | [`cordis-host-runner`](../packages/extensions/cordis-host-runner) | - | [`tool-cordis`](../packages/extensions/tool-cordis) | - | Registers Host inspect providers and serves schema-validated, cancellation-aware queries from model-facing tools. |

 ...
 */
@RemoteScope('agent', 'create') remoteExportCreate(request: CreateGoalRequest): CreateGoalResult
 ...
 */
@RemoteScope('agent', 'edit') remoteExportEdit(request: GoalRemoteEditRequest): CreateGoalResult
 ...
 */
@RemoteScope('agent', 'pause') remoteExportPause(request: GoalRemoteRefRequest): CreateGoalResult
 ...
 */
@RemoteScope('agent', 'resume') remoteExportResume(request: GoalRemoteRefRequest): CreateGoalResult
 ...
 */
@RemoteScope('agent', 'complete') remoteExportComplete(request: GoalRemoteRefRequest): CreateGoalResult
 ...
 */
@RemoteScope('agent', 'clear') remoteExportClear(request: GoalRemoteRefRequest): GoalRemoteClearResult
```

...
Configuration-time verification classifies authentication evidence independently from catalog reachability. The [LLM package](../../packages/llm/llm/README.md#use-this-package) owns deadlines, cancellation and fallback semantics.

...
| `@deepseek-ai/dsh-tool-agent-team` | `followup_task`, `interrupt_agent`, `list_agents`, `send_message`, `spawn_teammate`, `team_task_create`, `team_task_get`, `team_task_list`, `team_task_update`, `wait_agent` | `ctx.tools`, `ctx.systemPrompt`, `ctx.agentTeams`, `an exact live Team member Agent` | `tool/call`, `team/member`, `team/message/queued`, `team/message/delivered`, `team/task`, `tool/result` | - | All ten tools are scoped to implicit Team Leads and durable teammates. The shipped standard and code presets mount them in an isolated Team Agent realm while disabling the legacy continuable-child control names. |
...
All ten tools are scoped to implicit Team Leads and durable teammates. The shipped standard and code presets mount them in an isolated Team Agent realm while disabling the legacy continuable-child control names.

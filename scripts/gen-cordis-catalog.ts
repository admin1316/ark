...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentStatus: 'core.md',
  AgentQuiescenceResidual: 'core.md',
  CodeDispatchLog: 'tools.md',
  CredentialCondition: 'credentials.md',
  AgentPresetSelection: 'core.md',
  AgentPresetRemoved: 'core.md',
  AgentPresetDocumentOpen: 'core.md',
  RemoteResult: 'typert.md',
  RemoteCredentialsDescription: 'credentials.md',
  GoalRemoteEditRequest: 'goal.md',
  GoalRemoteRefRequest: 'goal.md',
  GoalRemoteClearResult: 'goal.md',
  RemoteLlmProviderMutationRequest: 'llm-streaming.md',
  RemoteLlmProviderMutationResult: 'llm-streaming.md',
  RemoteLlmProviderTransactionRequest: 'llm-streaming.md',
  RemoteLlmProviderVerificationRequest: 'llm-streaming.md',
  RemoteLlmProviderVerificationResult: 'llm-streaming.md',
  LlmProviderVerificationMode: 'llm-streaming.md',
  LlmModelDiscoveryOperation: 'llm-streaming.md',
  LlmProviderMigration: 'llm-streaming.md',
  RemoteLlmProviderTransactionResult: 'llm-streaming.md',
  RemoteLlmProviderResumeRequest: 'llm-streaming.md',
  RemoteLlmProvidersResult: 'llm-streaming.md',
  RemoteLlmModelsResult: 'llm-streaming.md',
  RemoteLlmDiscoverModelsRequest: 'llm-streaming.md',
  RemoteLlmDiscoveredModelsResult: 'llm-streaming.md',
  SessionRemoteListRequest: 'session.md',
  SessionRemoteListValue: 'session.md',
  SessionRemoteResult: 'session.md',
  SessionRemoteSearchRequest: 'session.md',
  SessionRemoteSearchValue: 'session.md',
  SessionRemoteCreateRequest: 'session.md',
  SessionRemoteCreateValue: 'session.md',
  SessionRemoteHistoryRequest: 'session.md',
  SessionRemoteHistoryValue: 'session.md',
  SessionRemoteModels: 'session.md',
  SessionRemoteModelsRequest: 'session.md',
  SessionRemoteSelectModelRequest: 'session.md',
  SessionRemoteSelectModelValue: 'session.md',
  SessionRemoteRenameRequest: 'session.md',
  SessionRemoteRenameValue: 'session.md',
  SessionRemoteForkRequest: 'session.md',
  SessionRemoteForkValue: 'session.md',
  SessionRemotePromptRequest: 'session.md',
  SessionRemotePromptValue: 'session.md',
  SessionRemoteAttachmentRequest: 'session.md',
  SessionRemoteAttachmentValue: 'session.md',
  SessionRemoteAcceptedValue: 'session.md',
  SessionRemoteUpdateQueueRequest: 'session.md',
  SessionRemoteCancelRequest: 'session.md',
  RemoteSettingsDescription: 'settings.md',
  RemoteSettingsDocumentOpenResult: 'settings.md',
  RemoteSettingsJsonObject: 'settings.md',
  RemoteSettingsNamespaceView: 'settings.md',
  RemoteSettingsPathOp: 'settings.md',
  RedactedSecret: 'settings.md',
  RemoteSkillCatalog: 'skills.md',
  DurableSubagentMessageReceipt: 'subagent.md',
  RemoteSubagentPromptReceipt: 'subagent.md',
  WorkspaceRemoteListValue: 'workspace.md',
  WorkspaceRemoteResult: 'workspace.md',
  WorkspaceRemoteCreateRequest: 'workspace.md',
  WorkspaceRemoteCreateValue: 'workspace.md',
  WorkspaceRemoteRenameRequest: 'workspace.md',
  WorkspaceRemoteWorkspaceValue: 'workspace.md',
  WorkspaceRemoteDeleteRequest: 'workspace.md',
  WorkspaceRemoteDeletedValue: 'workspace.md',
  WorkspaceRemoteInsertBeforeRequest: 'workspace.md',
  WorkspaceRemoteOrderValue: 'workspace.md',
  WorkspaceRemoteInsertSessionBeforeRequest: 'workspace.md',
  WorkspaceRemoteArchiveRequest: 'workspace.md',
  WorkspaceRemoteArchivedValue: 'workspace.md',
  WorkspaceRemoteDeleteArchivedRequest: 'workspace.md',
  WorkspaceRemoteDeleteArchivedValue: 'workspace.md',

...
- **Agent presets**: Ark defaults to the shipped `standard` preset and exposes preset selection and authoring through its native settings. Each session receives the tools and prompt owned by its selected preset.

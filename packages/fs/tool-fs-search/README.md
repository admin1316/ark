---
description: "The model-facing filesystem discovery tools—glob, grep—are backed by a packaged ripgrep binary, not by ctx.fs provider methods and not by a system rg install."

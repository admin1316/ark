...
export class FileSystemSkillProvider {
    ...
    async roots(cwd) {
        ...
        if (this.includeDefaultRoots) {
            ...
            roots.push({ path: join(this.dshHome, 'skills'), source: 'user-dsh', rank: USER_DSH_RANK, skipSystem: true, trustedHost: true }, { path: join(this.agentsHome, 'skills'), source: 'user-agents', rank: USER_AGENTS_RANK, trustedHost: true });
        }

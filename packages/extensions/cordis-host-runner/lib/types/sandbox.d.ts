...
export declare const HOST_BUILTIN_INSPECTION: readonly [{
    ...
    readonly description: "Host helpers for model-visible dynamic Tools.";
    readonly signatures: readonly ["harness.defineTool(definition: ToolDefinition): ToolDefinition", "harness.registerTool(ctx: Context, tool: ToolDefinition): () => void"];
}, {
 ...
 */
export declare function createSandbox(id: string): object;
/**
 ...
 */
export declare function parseErrorMessage(half: 'code.host', context: string): string;
/**
 ...
 */
export declare function precheckCode(code: string, half: 'code.host'): void;
/**

...
const SERVICE_API = [
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					...
					name: "options",
					description: "identities, session seed/metadata, loop options, setup, and cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					...
					name: "options",
					description: "persisted identity, loop options, setup, and cancellation."
				}],
				returns: "the published handle."
			}
		]
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "agentPreset",
					description: "user preset id, never a caller-supplied path."
				}, {
					name: "signal",
					description: "native command cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "agent",
					description: "exact Agent resolved by the Gateway."
				}, {
					name: "agentPreset",
					description: "requested preset id."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "options",
					description: "shared identity, session seed/metadata, and agent options."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "options",
					description: "persisted identity, configuration, and optional setup."
				}],
				returns: "the handle after setup, rollback-covered publication, and loop start complete."
			},
			{
			...
			},
			{
				...
				parameters: [{
					...
					name: "owner",
					description: "live agent whose scoped context created this agent, or undefined for a top-level runtime root. This is runtime ownership, not the resumed session's durable parent lineage."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					...
					name: "request",
					description: "revision-checked mutation."
				}],
				returns: "committed task view."
			},
			{
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "_ref",
					description: "normalized attachment reference to locate."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "expected",
						description: "optional condition checked under the same exclusion as all reference writes; a mismatch rejects without writing."
					}
				]
			},
			{
				...
				parameters: [{
					...
					name: "expected",
					description: "optional condition checked under the same exclusion as all reference writes; a mismatch rejects without deleting."
				}]
			},
			{
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "references",
						description: "optional conditions checked before `mutate`, with exclusion held through commit. Callbacks must not enqueue writes on this provider."
					}
				],
			...
			},
			{
				...
				parameters: [{
					name: "refs",
					description: "credential reference names to describe."
				}],
			...
			},
			{
				...
				parameters: [{
					...
					name: "value",
					description: "write-only credential value."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Goal reference and replacement fields."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Goal reference to pause."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Goal reference to resume."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Goal reference to complete."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "Goal reference to clear."
				}],
		...
		methods: [
			{
				...
				parameters: [{
					name: "request",
					description: "configured provider and model to verify."
				}, {
					name: "signal",
					description: "caller cancellation combined with the configured Host deadline."
				}],
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "model",
						description: "exact configured model."
					},
					{
						name: "signal",
						description: "owner cancellation and deadline."
					}
				],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "caller-stable transaction identity, revision and profile edits."
				}, {
					name: "signal",
					description: "cancellation before durable claim; claimed work keeps its ownership."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "provider and transaction identity retained by the native client."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "stored transaction identity and optional missing credential."
				}, {
					name: "signal",
					description: "cancellation before durable claim only."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "namespace, endpoint, protocol, and one-shot credential to use."
				}, {
					name: "signal",
		...
		methods: [
			{
				...
				parameters: [{
					name: "request",
					description: "Session identity to inspect and list."
				}],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "sessionId",
				description: "Session identity whose pending questions and approvals are inspected."
			}],
		...
		methods: [
			{
				...
				parameters: [{
					name: "events",
					description: "the session's events in log order."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "_id",
					description: "the persisted session to read (unused by the default: no per-session artifact)."
				}, {
					name: "signal",
					description: "optional cancellation for backend read work."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "_session",
					description: "exact live session whose registered header is materialized."
				}]
			},
			{
				...
				parameters: [{
					...
					name: "events",
					description: "the contiguous batch to persist, in seq order."
				}]
			},
			{
				...
				parameters: [{
					name: "id",
					description: "exact session identity to remove."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "id",
					description: "persisted session to prepare."
				}, {
					name: "signal",
					description: "optional cancellation for preparation work."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "id",
					description: "the persisted session to reload."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "id",
					description: "the persisted session to inspect."
				}, {
					name: "signal",
			...
			},
			{
				...
				parameters: [{
					name: "id",
					description: "persisted session to observe."
				}, {
					name: "signal",
					description: "optional cancellation for preparation work."
				}],
			...
			},
			{
				...
				parameters: [
					{
						name: "id",
						description: "the persisted session to read."
					},
					{
						name: "fromSeq",
						description: "first event seq to include; a non-negative safe integer."
					},
					{
						name: "signal",
						description: "optional cancellation for queued and backend read work."
			...
			},
			{
				...
				parameters: [{
					name: "signal",
					description: "optional cancellation for backend listing work."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "signal",
					description: "optional cancellation for backend snapshot-listing work."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					...
					{
						name: "meta",
						description: "observed lifecycle header."
					},
					{
						name: "events",
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					...
					name: "options",
					description: "seed events and/or creation metadata for the header. With `seedSource: 'persistence'`, metadata and events must be fresh detached graphs whose ownership transfers to this call: they are validated and frozen in place through {@link Session.fromRestore}, so the caller must retain no mutable aliases."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session listing filters and pagination."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session search query and bounds."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session history query and bounds."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session model discovery request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session model selection request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session fork request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session prompt request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "session attachment request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "pending queue update request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "active-turn cancellation request."
				}, {
					name: "signal",
					description: "caller-owned cancellation signal."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "signal",
					description: "transport cancellation, including the native command."
				}],
			...
			},
			{
				...
				parameters: [
					...
					},
					{
						...
						description: "revision read by the caller."
					}
				],
			...
			},
			{
				...
				parameters: [
					{
						name: "ns",
						description: "namespace to replace."
					},
					{
						name: "section",
						description: "complete new user layer, not a redacted readback."
					},
					{
						name: "expectedRevision",
						description: "revision read by the caller."
			...
			},
			{
				...
				parameters: [
					{
						name: "ns",
						description: "namespace to mutate."
					},
					{
						name: "ops",
						description: "path-addressed JSON edits."
					},
					{
						name: "expectedRevision",
						description: "revision read by the caller."
			...
			},
			{
				...
				parameters: [{
					name: "namespaces",
					description: "this calling fiber's complete protected set; other owners retain their reservations."
				}]
			},
			{
				...
				parameters: [{
					...
					name: "revision",
					description: "exact revision to observe; superseded revisions reject."
				}],
			...
			},
			{
				...
				parameters: [{
					...
					name: "ops",
					description: "proposed ordered edits; nothing is persisted."
				}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "agent",
					description: "Agent whose persisted cwd and scope determine visibility."
				}, {
					name: "signal",
					description: "Caller-owned cancellation signal."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [
					{
						name: "parent",
						description: "the exact live direct parent authorizing this delivery."
					},
					{
						name: "childId",
					...
					{
						name: "content",
						description: "user-role content to deliver."
					},
					{
						name: "options",
						description: "the message source fields and caller cancellation, which stops the operation only before inbox acceptance."
					}
				],
			...
			},
			{
				...
				parameters: [
					{
						name: "parent",
						description: "exact live direct parent."
					},
					{
						name: "childId",
						description: "durable child session id."
					...
					{
						name: "content",
						description: "content to deliver once per invocation."
					},
					{
						name: "options",
						description: "source, retry identity, and pre-admission cancellation."
					}
				],
			...
			},
			{
				...
				parameters: [
					{
						name: "parentSessionId",
						description: "durable parent authorizing the read."
					},
					{
						name: "childSessionId",
						description: "direct child session id."
					},
					{
						name: "mode",
						description: "expected child mode."
					},
					{
						name: "beforeSeq",
					...
					{
						name: "maxMessages",
						description: "bounded message count, validated by the Session owner."
					},
					{
						name: "signal",
						description: "read cancellation; neither Agent is resumed."
					}
				],
			...
			},
			{
				...
				parameters: [
					{
						name: "agent",
						description: "exact parent Agent supplied by the Gateway lookup."
					},
					{
						name: "childSessionId",
						description: "continuable direct child."
					},
					{
						name: "content",
						description: "human message content."
					},
					{
						name: "invocationId",
						description: "caller-stable UUID; conflicting reuse rejects."
					},
					{
						name: "signal",
						description: "cancellation before acceptance, not during the durability wait."
					}
				],
			...
			},
			{
				...
				parameters: [{
					name: "parentSessionId",
					description: "durable parent address."
				}, {
					name: "childSessionId",
					description: "continuable child; absent targets are accepted no-ops."
				}],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "endpoint",
				description: "slash-delimited Remote endpoint to inspect."
			}],
			...
			parameters: [
				{
					name: "endpoint",
					description: "slash-delimited Remote endpoint to invoke."
				},
				{
					name: "payload",
					description: "caller payload forwarded to the endpoint."
				},
				{
					name: "signal",
					description: "caller-owned cancellation signal."
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "provider",
				description: "answer collector for requests not claimed by scoped listeners."
			}],
	...
	},
	{
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					name: "transform",
					description: "pure html-to-html function over the rendered document."
				}],
			...
			},
			{
				...
				parameters: [{
					...
					name: "req",
					description: "the request the index response answers, when available."
				}],
		...
		methods: [
			{
				...
				parameters: [{
					name: "path",
					description: "Existing directory to own, in any path spelling."
				}, {
					name: "title",
			...
			},
			{
				...
				parameters: [{
					...
					name: "title",
					description: "initial title when a record is created."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "existing directory to own."
				}, {
					name: "signal",
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "workspace and replacement title."
				}, {
					name: "signal",
					description: "cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "registration to remove."
				}, {
					name: "signal",
					description: "cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "workspace and optional anchor."
				}, {
					name: "signal",
					description: "cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "workspace, session and optional anchor."
				}, {
					name: "signal",
					description: "cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "request",
					description: "archived root to delete."
				}, {
					name: "signal",
					description: "cancellation."
				}],
			...
			},
			{
				...
				parameters: [{
					...
					name: "title",
					description: "visible replacement title."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "sessionId",
					description: "identity to observe."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "sessionId",
					description: "identity being published."
				}, {
					name: "revision",
					description: "generation captured before asynchronous work."
				}]
			},
			{
			...
			},
			{
				...
				parameters: [{
					name: "sessionId",
					description: "archived identity to restore."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "sessionId",
					description: "archived root identity."
				}, {
					name: "retireResident",
					description: "exact lifecycle owner used to retire resident sessions."
				}],
			...
			},
			{
				...
				parameters: [{
					name: "path",
					description: "Existing directory path in any spelling."
				}],
...
const EVENT_API = [
	...
	},
	{
		...
		parameters: [{
			name: "payload",
			description: "Live agent, current turn and step, and residual-operation accounting."
		}]
	},
	{
		name: "agent/request",
	...
	},
	{
		...
		parameters: [{
			name: "sessionId",
			description: "permanently deleted identity."
		}]
	},
	{
	...
	},
	{
		...
		parameters: [{
			name: "dispatch",
			description: "the parent execution, sub-call identity, and settled content to log."
		}]
	},
	{
		name: "tools/result",
	...
	},
	{
		...
		parameters: [{
			...
			description: "current archive identities in durable order."
		}]
	},
	{
		...
		parameters: [{
			...
			name: "archivedSessionIds",
			description: "remaining archive overlay."
		}]
	}
];
...
const CORDIS_SYSTEM_PROMPT = `# Dynamic Cordis Host Plugins
	...
	ctx.tools.register(defineTool({
		...
		output: {
			...
			render: (_args, value) => {
				...
				return [{
					type: "text",
					text: `${pluginId}/${packageId} is ${requireJsonString(result, "status")} (${pluginRunId}).`
				}];
			},
			presentationMeta: (_args, value) => {
				const result = requireJsonObject(value);
...
function inspectSelfPackage(ctx, agent, pluginId, packageId) {
	...
	if (hostStatus === void 0) {
		hostStatus = "stopped";
		if (active !== void 0) hostStatus = hostWaiting.length === 0 ? "running" : "waiting";
	}
	return {
		mode: "package",

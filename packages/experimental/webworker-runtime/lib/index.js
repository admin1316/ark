	...
	async serveStream(frame) {
		...
		try {
			...
			if (!controller.signal.aborted) {
				const failure = seams.streamFailure === void 0 ? {
					code: "stream-failed",
					message: "webworker tunnel: Remote stream failed without a failure mapper",
					details: {}

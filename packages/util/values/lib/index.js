...
*/
function matchesOwnKeyPattern(value, required, forbidden) {
	return forbidden.every((key) => !Object.hasOwn(value, key)) && required.every((key) => Object.hasOwn(value, key));
}
...
//#endregion
export { assertNever, deepEqualJson, deepFreeze, isJsonValue, matchesOwnKeyPattern, snapshotJsonValue };

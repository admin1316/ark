...
export interface ApiRemoteAgentOptions {
    ...
    /**
     * Transfer observation of a handle created by this resolver to the owning
     * Host. The Agent factory remains the structural lifecycle owner; this hook
     * lets a Host retain the exact capability for a later policy-checked idle
     * retirement instead of attempting registry-wide destruction by id.
     */
 ...
 * @returns resolver shared by strict Agent/Session Typert lookups and their Host Gateway handlers.
 */

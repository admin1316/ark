 ...
 * else.
 */
export declare const API_REMOTE_FORWARDED_EVENTS: readonly ["agent-preset/selected", "commands/change", "credentials/reference-updated", "llm/adapters-updated", "settings/document-updated"];

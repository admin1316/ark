---
description: "Host-only Remote policy package. createApiRemoteAgentResolver() reuses live Agents, resumes ordinary cold sessions, deduplicates concurrent resumes, preserves subagent ownership, and configures the same resolver for Typert agent and session lookups."

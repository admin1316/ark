...
const _deepseek_ai_dsh_api_settings_controller_settings_describe_result$schema = z.object({
  ...
  'ns': z.string(),
  'schema': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema))]),
  'value': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema))]),
  'base': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema))]).optional(),
  'user': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema))]).optional(),
...
const _deepseek_ai_dsh_api_settings_controller_settings_mutate_parameter_1$schema = z.array(z.union([z.object({
  'op': z.literal("set"),
  'path': z.array(z.string()),
  'value': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema4)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema4))]),
}), z.object({
  'op': z.literal("unset"),
  'path': z.array(z.string()),
})]))
...
const _deepseek_ai_dsh_api_settings_controller_settings_mutate_result$schema = z.object({
  'ns': z.string(),
  'schema': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5))]),
  'value': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5))]),
  'base': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5))]).optional(),
  'user': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema5))]).optional(),
  'applies': z.union([z.literal("live"), z.literal("restart")]),
  'secrets': z.array(z.object({
  'path': z.array(z.string()),
  'set': z.boolean(),
...
const _deepseek_ai_dsh_api_settings_controller_settings_replace_parameter_1$schema = z.record(z.string(), z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => JsonValueRemoteCodec$schema2)), z.record(z.string(), z.lazy(() => JsonValueRemoteCodec$schema2))]))
...
const _deepseek_ai_dsh_api_settings_controller_settings_replace_result$schema = z.object({
  'ns': z.string(),
  'schema': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3))]),
  'value': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3))]),
  'base': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3))]).optional(),
  'user': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema3))]).optional(),
  'applies': z.union([z.literal("live"), z.literal("restart")]),
  'secrets': z.array(z.object({
  'path': z.array(z.string()),
  'set': z.boolean(),
...
const _deepseek_ai_dsh_api_settings_controller_settings_update_parameter_1$schema = z.record(z.string(), z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => JsonValueRemoteCodec$schema)), z.record(z.string(), z.lazy(() => JsonValueRemoteCodec$schema))]))
...
const _deepseek_ai_dsh_api_settings_controller_settings_update_result$schema = z.object({
  'ns': z.string(),
  'schema': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2))]),
  'value': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2))]),
  'base': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2))]).optional(),
  'user': z.union([z.literal(null), z.string(), z.number(), z.literal(false), z.literal(true), z.array(z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2)), z.record(z.string(), z.lazy(() => RemoteSettingsJsonValueRemoteCodec$schema2))]).optional(),
  'applies': z.union([z.literal("live"), z.literal("restart")]),
  'secrets': z.array(z.object({
  'path': z.array(z.string()),
  'set': z.boolean(),
  ...
  invocations: [
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/credentials.ts","line":86,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/credentials.ts","line":103,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/credentials.ts","line":116,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":136,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":122,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":185,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":231,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":200,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":166,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/index.ts","line":149,"column":3},
    },
  ],
  model: {
    "services": [
      ...
      },
      {
        ...
        "types": [
          ...
          },
          {
            ...
            "declaration": "export type SettingsPathOpView = { op: 'set'; path: string[]; value: RemoteSettingsJsonValue; } | { op: 'unset'; path: string[]; };"
          },
          {

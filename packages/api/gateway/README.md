---
description: "Host-only dispatcher for strict Typert Remote methods used by native API clients."
...
- [Carrier boundary](#carrier-boundary)
...
A missing active Service returns `service-unavailable` with the Service identity and a Host provider-composition hint. The diagnostic excludes request arguments and credential values.

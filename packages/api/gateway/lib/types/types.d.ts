...
export type TypertGatewayErrorCode = 'arguments-invalid' | 'binding-invalid' | 'cancelled' | 'context-failed' | 'context-not-found' | 'context-unavailable' | 'definition-invalid' | 'definition-unavailable' | 'input-invalid' | 'invocation-unavailable' | 'lookup-failed' | 'lookup-not-found' | 'lookup-unavailable' | 'method-unavailable' | 'provider-mismatch' | 'result-invalid' | 'service-unavailable';

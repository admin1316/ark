 ...
 */
export async function runJsonrpcAgent(bareModuleBaseUrl) {
    installFailLoud(NAME);
    // Layered env with bootstrap-name rejection: a .env must never be able to
    // redirect the harness home or inject process-launch variables
    // (DSH_*, NODE_OPTIONS, LD_PRELOAD, ...). Mirrors the product CLI track.
    loadLayeredEnv(NAME);

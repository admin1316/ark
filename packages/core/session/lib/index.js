...
/**
* Brand one caller-minted prompt identity without exposing a transport id.
* @param id - The id input.
* @returns The value produced by session prompt invocation id.
*/
function SessionPromptInvocationId(id) {
	return id;
}
/**
...
*/
function forkSeed(events, sessionId, requestedBoundary) {
	...
	if (lastTurnBoundary?.type === "turn/start") throw new SessionForkError(`fork boundary ${boundary} in session "${sessionId}" ends inside open turn ${lastTurnBoundary.data.turn}`, "OPEN_TURN");
...
*/
function resolveForkSource(source, get) {
...
*/
/**
* Find and parse the latest durable tool call with one id.
* @param events - session-log window searched newest first.
* @param callId - durable tool call identity.
* @returns the call name and parsed arguments, or undefined for no/invalid call.
*/
function findToolCallArguments(events, callId) {
...
*/
function sessionRemoteUnavailable() {
	return {
		ok: false,
		error: {
...
*/
function sessionRemoteCancelled() {
	return {
		ok: false,
		error: {
			code: "cancelled",
...
let SessionStore = (() => {
	...
	return class SessionStore extends _classSuper {
		static {
			...
			__esDecorate(this, null, _remoteExportSearch_decorators, {
				kind: "method",
				name: "remoteExportSearch",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportSearch" in obj,
					get: (obj) => obj.remoteExportSearch
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _remoteExportHistory_decorators, {
				kind: "method",
				name: "remoteExportHistory",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportHistory" in obj,
					get: (obj) => obj.remoteExportHistory
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportModels_decorators, {
				kind: "method",
				name: "remoteExportModels",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportModels" in obj,
					get: (obj) => obj.remoteExportModels
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportSelectModel_decorators, {
				kind: "method",
				name: "remoteExportSelectModel",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportSelectModel" in obj,
					get: (obj) => obj.remoteExportSelectModel
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _remoteExportFork_decorators, {
				kind: "method",
				name: "remoteExportFork",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportFork" in obj,
					get: (obj) => obj.remoteExportFork
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportPrompt_decorators, {
				kind: "method",
				name: "remoteExportPrompt",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportPrompt" in obj,
					get: (obj) => obj.remoteExportPrompt
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportAttachment_decorators, {
				kind: "method",
				name: "remoteExportAttachment",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportAttachment" in obj,
					get: (obj) => obj.remoteExportAttachment
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportUpdateQueue_decorators, {
				kind: "method",
				name: "remoteExportUpdateQueue",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportUpdateQueue" in obj,
					get: (obj) => obj.remoteExportUpdateQueue
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportCancel_decorators, {
				kind: "method",
				name: "remoteExportCancel",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportCancel" in obj,
					get: (obj) => obj.remoteExportCancel
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		*/
		...
		async invokeRemote(invoke, signal) {
			if (signal.aborted) return sessionRemoteCancelled();
			const operations = this.ctx.get("sessionRemoteOperations");
			if (operations === void 0) return sessionRemoteUnavailable();
			return sessionRemoteResultAfterOperation(signal, await invoke(operations));
		}
		/**
...
//#endregion
export { KNOWN_SESSION_EVENT_TYPES, SESSION_FORMAT_VERSION, Session, SessionForkError, SessionId, SessionPreparation, SessionPromptInvocationId, SessionStore, SessionStore as default, TOOL_NOT_STARTED, TOOL_OUTCOME_UNKNOWN, adoptSessionEvent, canonicalHeader, decodeSeqRanges, decodeStorageRecord, deriveEventMessage, encodeSeqRanges, findToolCallArguments, foldRequestHeader, foldSurface, headerEquals, interruptedTurnClosers, isAppendSurfaceEvent, isJsonValue, isReplacementSurfaceEvent, isSurfaceEligibleType, isSurfaceEvent, packChunkRuns, snapshotJsonValue, snapshotSessionEvent };

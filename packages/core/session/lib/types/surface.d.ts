...
/** Parsed identity and arguments of one durable tool call. */
export interface SessionToolCallArguments {
    name: string;
    args: unknown;
}
/**
 ...
 */
export declare function findToolCallArguments(events: readonly SessionEvent[], callId: string): SessionToolCallArguments | undefined;
/**

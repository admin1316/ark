 ...
 */
export function validateSessionHeader(id, input) {
 ...
 * @returns the validated, frozen header.
 */
export function validateRestoredSessionHeader(id, input) {
    if (input !== null && typeof input === 'object' && !Array.isArray(input)) {
 ...
 * @returns the validated, frozen header.
 */
export function snapshotSessionHeader(id, source) {
 ...
 */
export function freezeRestoredObject(value) {
    const pending = [value];
 ...
 */
export function assertSessionEventEnvelope(value, index) {
    const event = value;
 ...
 * @param index - the seed index used in rejection messages.
 */
export function assertCurrentLlmShape(event, index) {
 ...
 * @param index - the seed index used in rejection messages.
 */
export function assertAdapterDefaults(value, config, index) {
    if (value === undefined)
        return;
 ...
 */
export function assertMessageEventShape(event, subject) {
    const type = event['type'];
    if (type !== 'user/message' && type !== 'assistant/message'
        && type !== 'tool/result')
        return;
 ...
 */
export function hasProviderModel(value) {
 ...
 */
export function assertSupportedRequestHeader(type, data, location) {

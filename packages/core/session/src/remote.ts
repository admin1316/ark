...
export type SessionRemoteQueueAction =
  | { readonly kind: 'edit'; readonly content: readonly JsonValue[] }
  | { readonly kind: 'remove' }
  | { readonly kind: 'steer' }

/** Inputs and outputs for `session/list`. */
export interface SessionRemoteListRequest { readonly cursor?: string }
/**
 * Describes the session remote list value value used by this package.
 */
export interface SessionRemoteListValue { readonly items: readonly SessionRemoteSummary[] }

/** Inputs and outputs for `session/search`. */
export interface SessionRemoteSearchRequest { readonly query: string }
/**
 ...
 */
export interface SessionRemoteSelectModelValue { readonly selected: SessionRemoteModelSelection }
 ...
 */
export interface SessionRemoteForkValue { readonly sessionId: SessionId }
 ...
 */
export interface SessionRemoteAcceptedValue { readonly accepted: true }
/**
 * Describes the session remote cancel request value used by this package.
 */
export interface SessionRemoteCancelRequest { readonly sessionId: SessionId }
 ...
 */
export function sessionRemoteUnavailable(): SessionRemoteFailure {
  return {
    ok: false,
    error: {
 ...
 */
export function sessionRemoteCancelled(): SessionRemoteFailure {
  return {
    ok: false,
    error: {
      code: 'cancelled',

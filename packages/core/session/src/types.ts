...
// Generated Remote consumers import only the public `./types` outlet, never
// the Host root. Keeping this re-export here gives every Session Remote
// request/result one stable, non-root public type path.
...
/** Opaque caller identity persisted with one admitted user prompt. */
export type SessionPromptInvocationId = Branded<'SessionPromptInvocationId'>
 ...
 */
export function SessionPromptInvocationId(id: string): SessionPromptInvocationId {
  return id as SessionPromptInvocationId
}

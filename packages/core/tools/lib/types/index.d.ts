...
export type { CodeDispatchEventData, CodeDispatchStartEventData, PtcDispatchEventData, PtcDispatchStartEventData, } from './types.ts';
...
export { TOOL_ABORTED, TOOL_ABORTED_BEFORE_DISPATCH, ToolNotFoundError, ToolOutputError } from './executor.ts';
...
/** PTC spelling of the nested dispatch projection; retained as an alias for old consumers. */
export type PtcDispatchLog = CodeDispatchLog;
/**
 ...
 */
export declare function isPtcPresentationMode(mode: ToolPresentationMode): boolean;

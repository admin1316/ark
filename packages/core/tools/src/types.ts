...
/** PTC spelling of the nested dispatch payload; the wire event stays stable for replay. */
export type PtcDispatchStartEventData = CodeDispatchStartEventData
...
/** PTC spelling of the nested dispatch payload; the wire event stays stable for replay. */
export type PtcDispatchEventData = CodeDispatchEventData

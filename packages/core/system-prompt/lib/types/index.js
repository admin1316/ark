 ...
 * use any finite order; equal orders are resolved by code-unit section name.
 */
...
/** Deterministic section ordering independent of registration timing. */
function comparePromptSections(a, b) {
    return a.order - b.order || Number(a.name > b.name) - Number(a.name < b.name);
}
/**

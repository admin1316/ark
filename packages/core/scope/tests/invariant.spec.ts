...
describe('scoped-dispatch invariants', () => {
  ...
  it('checks every generated subject resolver against the carrier key', async () => {
    ...
    const agentRows = {
      ...
      'agent/quiescence-timeout': [{
        ...
        residual: {
          ...
          budget: { elapsedMs: 1_100, steps: 0, modelAttempts: 0, toolCalls: 0 },
        },
      }],
    ...
    const rows: Array<[string, unknown[]]> = [
      ...
      ['tools/ptc-dispatch-log', [{ exec: { callId: 'c', name: 't', arguments: {} }, agent, subCallId: 'c:ptc:1', name: 't', isError: false, content: [] }, () => Promise.resolve([])]],

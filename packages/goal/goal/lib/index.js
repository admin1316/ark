...
import { RemoteScope, TypertLookupFailure, TypertRemoteService } from "@deepseek-ai/dsh-typert-protocol";
...
let GoalService = (() => {
	...
	return class GoalService extends _classSuper {
		static {
			...
			__esDecorate(this, null, _remoteExportEdit_decorators, {
				kind: "method",
				name: "remoteExportEdit",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportEdit" in obj,
					get: (obj) => obj.remoteExportEdit
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportPause_decorators, {
				kind: "method",
				name: "remoteExportPause",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportPause" in obj,
					get: (obj) => obj.remoteExportPause
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportResume_decorators, {
				kind: "method",
				name: "remoteExportResume",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportResume" in obj,
					get: (obj) => obj.remoteExportResume
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportComplete_decorators, {
				kind: "method",
				name: "remoteExportComplete",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportComplete" in obj,
					get: (obj) => obj.remoteExportComplete
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _remoteExportClear_decorators, {
				kind: "method",
				name: "remoteExportClear",
				static: false,
				private: false,
				access: {
					has: (obj) => "remoteExportClear" in obj,
					get: (obj) => obj.remoteExportClear
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		*/
		...
		remoteAgent() {
			...
			if (agent === void 0) throw remoteGoalFailure("goal Remote receiver has no active Agent context", "GOAL_AGENT_NOT_LIVE");
			this.assertLive(agent);
			return agent;
		}
		...
		remoteGoal(operation) {
			try {
				...
				if (error instanceof GoalError) throw remoteGoalFailure(error.message, error.code);
				throw error;
			}
		}
	};

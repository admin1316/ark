...
import type { CreateGoalRequest, CreateGoalResult, EditGoalRequest, GoalBlockReason, GoalProjection, GoalRef, GoalRemoteClearResult, GoalRemoteEditRequest, GoalRemoteRefRequest, GoalView } from './types.ts';

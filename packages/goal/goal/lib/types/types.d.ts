...
/** Wire request for one compare-and-set Goal edit. */
export interface GoalRemoteEditRequest extends EditGoalRequest {
    readonly ref: GoalRef;
}
/** Wire request for one compare-and-set Goal phase change. */
export interface GoalRemoteRefRequest {
    readonly ref: GoalRef;
}
/** Wire acknowledgement of a cleared Goal tombstone. */
export interface GoalRemoteClearResult {

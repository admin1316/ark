 ...
 */
export function parseFrontmatterField(line) {
 ...
 */
export function renderCanonicalFrontmatterField(field, value) {
 ...
 */
export function renderPreservedFrontmatterField(field, value) {
 ...
 */
export function parseFrontmatterArray(value) {
 ...
 */
export function formatFrontmatterArray(items) {
 ...
 */
export function canonicalizeSourcesField(rawValue, currentIdentity) {
    const items = [...new Set(parseFrontmatterArray(rawValue)
            .map(normalizeSourceReference)
            .filter(isValidSourceReference))];
    const identity = normalizeSourceReference(currentIdentity);
    if (isValidSourceReference(identity) && !items.includes(identity))
        items.push(identity);
 ...
 */
export function stampSourcesField(content, currentIdentity) {

 ...
 */
export function sourceSummaryFileNameFromIdentity(sourceIdentity: string): string {
...
function readableSlugPart(part: string): { readonly readable: string; readonly structuralLength: number } {
...
function fnv32Base36(value: string): string {
  let hash = 0x811c9dc5

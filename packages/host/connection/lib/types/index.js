...
export { API_PATH, HOST_EVENTS_PATH, MUX_EVENTS_PATH, RESPOND_PATH } from "./api-path.js";
/** Stable Cordis plugin name. */
export const name = 'host-connection';
...
function assertImageBodyCapacity(ctx, maxRequestBodyBytes) {
    ...
    if (maxRequestBodyBytes < requiredImageBodyBytes) {
        throw new Error(`host-connection maxRequestBodyBytes (${String(maxRequestBodyBytes)}) must be at least `

...
const workbenchWebReadRequestSchema = z.object({
    url: z.string().min(1),
});
...
let WorkbenchRemoteService = (() => {
    ...
    return class WorkbenchRemoteService extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _webRead_decorators, { kind: "method", name: "webRead", static: false, private: false, access: { has: obj => "webRead" in obj, get: obj => obj.webRead }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async webRead(request, signal) {
            ...
            if (isAborted(signal))
                throw cancelled('workbench web read was aborted');
            try {

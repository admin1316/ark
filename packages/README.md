...
| [`api/`](api/README.md) | Host-side identity and forwarded-event policy for the native API | Product — stable API |
...
| [`host/`](host/README.md) | Native/API host layer: API gateway, authenticated transport, and loopback route server | Product — stable API |

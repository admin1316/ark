...
export { SessionPersistenceDeleteBlockedError } from "./errors.js";
...
export class PersistenceCoordinator {
    ...
    async delete(id) {
        ...
        const deleted = await this.serialize(id, async () => {
            ...
            if (!this.preparations.discardForDelete(id))
                throw new SessionPersistenceDeleteBlockedError(id, 'reserved');

---
description: "CompactionEngine（ctx.compaction）定义压缩（compaction）做什么，即判定历史记录是否过大，并将较早范围摘要为单个表层节点，但不规定如何实现。"
...
- [服务 API（ctx.compaction）](#service-api-ctxcompaction)
- [工具配对边界](#tool-pairing-boundaries)
- [表层约定](#surface-contract)
- [阻塞](#blocking)
- [事件](#events)
- [实现后端](#implementing-a-backend)
- [在 host 程序之外识别检查点（./checkpoint）](#recognizing-a-checkpoint-outside-the-host-program-checkpoint)
- [模型体验](#model-experience)
- [已知限制与暂缓事项](#known-limitations-and-deferred-work)
- [开发备注](#dev-note)

<a id="service-api-ctxcompaction"></a>
...
<a id="recognizing-a-checkpoint-outside-the-host-program-checkpoint"></a>

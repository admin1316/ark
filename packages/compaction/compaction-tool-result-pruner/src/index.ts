...
import { codePointLength, DEFAULTS, PRUNE_MARKER, resolvePruneConfig } from './config.ts'
import type {
  PrunedEntry,
  PruneResult,
  ResolvedConfig,
...
export { codePointLength, DEFAULTS, PRUNE_MARKER, resolvePruneConfig } from './config.ts'
export type {
  PrunedEntry,
  PruneResult,
  ResolvedConfig,
...
export class ToolResultPruner extends Service {
  ...
  constructor(ctx: Context, config: ToolResultPruneConfig = {}) {
    ...
    this.config = resolvePruneConfig(config)
  }

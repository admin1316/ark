...
export type SubagentHistoryOptions = Omit<SessionRemoteRawHistoryRequest, 'sessionId' | 'expectedParentSessionId' | 'expectedSubagentMode'>
  | Omit<SessionRemoteSemanticHistoryRequest, 'sessionId' | 'expectedParentSessionId' | 'expectedSubagentMode'>
  | Omit<SessionRemoteHistoryContentRequest, 'sessionId' | 'expectedParentSessionId' | 'expectedSubagentMode'>

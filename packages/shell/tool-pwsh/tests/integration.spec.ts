...
import { PwshLocalExecutor, pwshTestsAvailable } from '@deepseek-ai/dsh-pwsh-local'
import * as ToolPwsh from '@deepseek-ai/dsh-tool-pwsh'
import * as BashEnvPlugin from '@deepseek-ai/dsh-shell-env'

const testToolSignal = new AbortController().signal

// The shared probe follows the executor's own resolution (Program Files
// installs on Windows are found even when bare `pwsh` is not on PATH).

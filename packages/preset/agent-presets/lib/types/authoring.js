...
export class InvalidPresetIdError extends Error {
    ...
    /** The rejected id. */
    presetId) {
        super(`agent-presets: preset id ${JSON.stringify(presetId)} must match ${String(PRESET_ID)} — `
 ...
 */
export async function deleteComposition(roots, preset) {

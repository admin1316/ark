 ...
 */
export async function assistantUpdates(ctx, session, event, allowStaleImageReference = false) {
    const updates = [];
    for (const block of event.data.message.content) {
        ...
        try {
            ...
            if (block.type !== 'image' || !allowStaleImageReference)
                throw error;
            ...
            content = { type: 'text', text: `[image attachment ${String(block.attachment.attachmentId)}]` };
        }

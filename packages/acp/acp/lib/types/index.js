...
import { createOwnedStdioStream } from "./stdio.js";
...
export function apply(ctx, config) {
    ...
    const implementation = {
        ...
        async resumeSession(params, signal) {
            assertOpen();
            if (persistence === undefined)
                throw internalError('session/resume requires a session persistence backend');
            validateWorkspaceParams(params);
        ...
        async listSessions(params, signal) {
            assertOpen();
            if (persistence === undefined)
                throw internalError('session/list requires a session persistence backend');

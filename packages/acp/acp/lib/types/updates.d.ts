 ...
 */
export declare function assistantUpdates(ctx: Context, session: Session, event: SessionEvent<'assistant/message'>, allowStaleImageReference?: boolean): Promise<SessionUpdate[]>;
/**

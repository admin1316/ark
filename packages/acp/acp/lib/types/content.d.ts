 ...
 */
export declare function admitAcpPrompt(ctx: Context, routeOrAgent: ModelSelection | Agent | undefined, prompt: readonly AcpContentBlock[], imageEnabled: boolean, signal: AbortSignal): Promise<ContentBlock[]>;
/**

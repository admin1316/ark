...
var AssistantStreamAccumulator = class {
	...
	push(value) {
		...
		switch (chunk.type) {
			...
			case "finish":
				...
				return timed;
			default: return assertNever$1(chunk, "AssistantStreamAccumulator.push");
		}
	}
	/**
	...
	*/
	snapshot() {
		return deepFreeze$1(this.records.map((record) => {
...
function assembleAssistantStream(stream, assembler = new BlockAssembler()) {
	for (const record of stream) switch (record.type) {
		...
		case "tool-call-chunks":
			...
			break;
		default: assertNever$1(record, "assembleAssistantStream");
	}
	return assembler;
}
...
//#endregion
export { APP_IDENTITY, AssistantStreamAccumulator, BlockAssembler, CONTEXT_SUMMARY_MAX_CHARS, CONTEXT_WINDOW_EXCEEDED_CODE, CallId, EMPTY_RESPONSE_CODE, HarnessError, INVALID_CREDENTIAL_CODE, LlmAdapter, LlmError, LlmRuntime, LlmRuntime as default, MALFORMED_TOOL_CALL_CODE, MessageId, ProviderRequestId, QUOTA_EXCEEDED_CODE, ReasoningEffortId, RetryPolicySchema, assembleAssistantStream, assertNever, assertUsableApiKey, assistantStreamChunks, assistantStreamFirstTokenTime, assistantStreamHasVisibleContent, assistantStreamHasVisibleText, attributionHeaders, boundContextSummary, callConfigEquals, chunkHasVisibleText, contentHasImage, createAssistantMessage, createMessage, createToolResultMessage, createUserMessage, deepFreeze, errorChain, expandAssistantStream, freezeMessage, isAgentLoopRequest, isContextWindowExceededError, isCredentialHeaderName, isHarnessError, isQuotaExceededError, isTokenDelta, isVisibleChunk, joinAssistantStreamText, lastAssistantStreamChunk, markAgentLoopRequest, modelDiscoveryEndpointFingerprint, normalizeApiKey, offloadRequestImagesWithPolicy, offloadedImagePrefixCount, offloadedImageText, projectImagesForTextModel, requestImageHandleText, resolveImageAttachmentAccess, resolveRetryPolicy, runFirstTokenTime, runFirstVisibleTime, textOnlyImageText, userAgent };

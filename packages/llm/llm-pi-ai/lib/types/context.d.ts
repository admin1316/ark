 ...
 * @param resolveImageAccess - The resolve image access input.
 */
export declare function toPiContext(options: GenerateOptions, attachments: AttachmentStore, onReplayDegrade?: (reason: string) => void, maxRequestImageBytes?: number, requestImagePolicy?: ImageRequestPolicy, resolveImageAccess?: ImageAttachmentAccessResolver): Promise<PiContext>;

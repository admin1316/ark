...
- The Native shell presents `plan-review` through its native interaction flow; another interaction provider may present the same request through a generic option flow.

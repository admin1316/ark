import { n as INSTALL_ANCHOR } from "./installation-C2WHY-2K.js";
import { existsSync } from "node:fs";
import { loadOptionalPatches, loadOverlayPatches, renderConfigDump } from "@deepseek-ai/dsh-app-boot";
import { join, resolve } from "node:path";
import { PROFILE_ROOT_FILENAME, homePatchPath, prepareProfile } from "@deepseek-ai/dsh-profile-runner";
...
function runDumpConfig(profile, defaultOnly, patches) {
	const loaded = prepareProfile(profile, INSTALL_ANCHOR, !defaultOnly);

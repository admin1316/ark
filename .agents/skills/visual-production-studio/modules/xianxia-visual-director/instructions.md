...
5b. Read [references/celestial-prosperity-real.md](references/celestial-prosperity-real.md) when the scene is a "繁华天庭/仙宫/极乐盛宴" that must look luxurious but NOT cheap (gold as accent, dark base, layered density, uncanny dread techniques).

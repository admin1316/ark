...
- [Web terminal card](../../archived/feature/2026-07-28-web-terminal-card.md) —— 把 bash `terminal` 渲染意图带到浏览器的先例；[Web result card 前端](../../archived/feature/2026-07-30-web-result-card-frontend.md)是它针对这一分支的对应方案。

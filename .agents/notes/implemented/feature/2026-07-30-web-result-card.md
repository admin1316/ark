...
- [Web terminal card](../../archived/feature/2026-07-28-web-terminal-card.md) — the precedent that carried the bash `terminal` render intent to the browser; the [web result card frontend](../../archived/feature/2026-07-30-web-result-card-frontend.md) is its analogue for this arm.
